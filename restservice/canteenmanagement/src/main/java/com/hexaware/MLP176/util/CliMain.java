...
>>>>>>> 86794babf968a27b49364007655274b2f311840c
    ...
    if (choice == 2) {
      ...
      if (count == 1) {
        ...
        System.out.println("----------------------------------------------------------------------------"
            + "------------------------------------");
        System.out.printf("%-10s %-10s %-10s %-10s %-10s %-10s %-10s %-10s %-10s", "Item Id", "Menu Id",
  ...
  private void pendingOrders() {
    ...
    if (choice == 1) {
      ...
      if (count == 1) {
        ...
        System.out.println("------------------------------------------------------------------------"
            + "------------------------------------------------------------------------");
        System.out.printf("%-15s %-15s %-15s %-15s %-15s %-15s %-15s %-15s %-15s %-15s", "Order Id", "Cus Id",
            "Vendor Id", "Menu ID", "Order Status", "Order Comments", "Bill Amount",
            "Order Date", "Order Qty", "Wal Type");
        System.out.println();
        System.out.println("------------------------------------------------------------------------"
            + "------------------------------------------------------------------------");
        for (Orders order : cusHistory) {
...
*show all vendors.
*/
  private void showFullVen() {

    Vendor[] vendor1 = VendorFactory.showVendor();
    //int vendId = vendor.getVendorId();
    //Orders[] venHistory = OrderFactory.showpendingVendorOrders(vendId);
    System.out.println("------------------------------------------------------------------------"
        + "--------------------");
    System.out.printf("%-15s %-15s %-15s %-15s %-15s %-15s", "Vendor Id", "Vendor Name",
        "Vendor UserName", "Vendor Number", "Vendor Email", "Vendor Pass");
    System.out.println();
    System.out.println("-------------------------------------------------------------------------"
         + "-------------------");
    for (Vendor m : vendor1) {
      System.out.println(m);
      System.out.println();
    }
  }
 ...
 */
  private void showFullVendor() {
    String user;
    String password;
    System.out.println("Enter the Username of Vendor");
    user = option.next();
    Console console = System.console();
    ...
    if (count == 1) {
      ...
      System.out.println("VendorId      VendorName     UserName           Number         VendorEmail");
      System.out.println(vendorFound);
    } else {
      System.out.println("Invalid credentials of Vendor");
    }
 ...
 */
  private void showFullOrders() {
    ...
    //System.out.println("ORDER ID,CUST ID,VEN ID,MEN ID,ORD STATUS,ORDCOMMENTS,ORDTOTAL_AMT,ORDDATE,ORDQTY");
    System.out.println("-----------------------------------------------------------------"
        + "---------------------------------------------------------------------------------");
    System.out.printf("%-10s %-10s %-10s %-10s %-10s %-10s %-10s %-10s %-10s %-10s", "Order Id", "CustomerId", "Vendor Id",
        "Menu Id", "Order Status", "Order Cmts", "Total Amount", "Order Date", "Order Qty", "Wal Type");
    //System.out.println("-------------------------------------------");
    System.out.println();
    System.out.println("------------------------------------------------------------------------"
        + "------------------------------------------------------------------------");
 ...
 */
  private void showFullCustomer() {
    ...
    if (count == 1) {
      ...
      System.out.println("Invalid credentials of Customer");
    }
  }
/**
