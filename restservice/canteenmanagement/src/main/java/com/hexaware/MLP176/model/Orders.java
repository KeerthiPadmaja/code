 ...
 */
  ...
  @Override
    ...
    return Objects.hash(orderId, customerId, vendorId, menuId, orderStatus, orderComments, orderTotalamount,
              orderDate, orderQuantity, walletType);
  }
  @Override
    public final String toString() {
    return String.format("%-10s %-10s %-10s %-10s %-10s %-10s %-10s %-10s %-10s %-10s", orderId, customerId, vendorId,
