...
public class OrderFactoryTest {
  ...
  @Test
   public final void testListAllSome(@Mocked final OrderDAO dao) throws ParseException {
    ...
    final Orders o2 = new Orders(1, 100, 4, 1, OrderStatus.ACCEPTED, "SWEET", 200.00000, odt, 4, WalletType.PAYTM);
    final Orders o3 = new Orders(2, 101, 5, 2, OrderStatus.REJECTED, "SPICY", 201.00000, odt, 5, WalletType.GOOGLE_PAY);
  ...
  public final void testAcceptOrReject(@Mocked final OrderDAO dao) throws ParseException {
    ...
    final Orders order1 = new Orders(1, 100, 4, 1, OrderStatus.ACCEPTED, "SWEET", 200.00000, odt, 4, WalletType.PAYTM);
    new Expectations() {
        {
  ...
  * @throws ParseException for converting date to string.
  ...
  public final void testcancelOrder(@Mocked final OrderDAO dao) throws ParseException {
    ...
    final String dt = new String("2020-03-18");
    final Date odt = sdf.parse(dt);
    final Orders order2 = new Orders(12, 4, 100, 1, OrderStatus.PENDING, "SWEET", 200.00000, odt, 4, WalletType.PAYTM);
    final Orders order3 = new Orders(22, 6, 102, 1, OrderStatus.ACCEPTED, "SWEET", 200.00000, odt, 4, WalletType.PAYTM);
